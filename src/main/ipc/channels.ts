export const IpcChannels = {
  ...
  PROVIDERS_GET_HEALTH_SCHEDULER_CONFIG: 'providers:getHealthSchedulerConfig',
  PROVIDERS_UPDATE_HEALTH_SCHEDULER_CONFIG: 'providers:updateHealthSchedulerConfig',
