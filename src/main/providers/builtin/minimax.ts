...
export const minimaxConfig: BuiltinProviderConfig = {
  ...
  credentialFields: [
    ...
    },
    {
      ...
      type: 'password',
      required: false,
      placeholder: 'Paste MiniMax web Cookie header value (optional)',
    ...
    },
    {
      ...
      type: 'text',
      required: false,
      placeholder: 'Enter MiniMax chat_id from a successful send_msg request (optional)',
      helpText: 'Optional MiniMax web chat_id from a successful send_msg request. If provided, Chat2API will include it in send_msg body.',
    },
  ],
